...
public class JvstTest extends JvstTestRoot {
    ...
    public void testClassPoolGet() throws Exception {
        ClassPool pool = ClassPool.getDefault();
        CtClass cc = pool.makeClass("test1.main.Point");
        CtClass cc1 = pool.get("test1.main.Point");   // cc1 is identical to cc.
        cc.setName("test1.Pair");
        CtClass cc2 = pool.get("test1.Pair");    // cc2 is identical to cc.
        CtClass cc3 = pool.get("test1.main.Point");   // cc3 is not identical to cc.
        ...
        assertEquals("test1.main.Point", cc3.getName());
    }
