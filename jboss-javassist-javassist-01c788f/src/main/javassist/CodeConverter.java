 ...
 * CtClass point = cp.get("main.Point");
 ...
 * for all occurrences of "<code>new main.Point()</code>"
...
public class CodeConverter {
     ...
     * compile-time classes for class <code>main.Point</code> and class
     * <code>Singleton</code>, respectively)
     * replaces all occurrences of:
     *
     * <pre>new main.Point(x, y)</pre>
     *
     * in the method body with:
     *
     * <pre>Singleton.createPoint(x, y)</pre>
     *
     * <p>This enables to intercept instantiation of <code>main.Point</code>
     * and change the samentics.  For example, the following
     * <code>createPoint()</code> implements the singleton pattern:
     *
     * <pre>public static main.Point createPoint(int x, int y) {
     *     if (aPoint == null)
     *         aPoint = new main.Point(x, y);
     *     return aPoint;
     * }
     * </pre>
     *
     ...
     *
     * <p>Note that <code>Point2</code> must be type-compatible with <code>main.Point</code>.
     ...
     *
     * <pre>main.Point p = new main.Point();
     * int newX = p.x + 3;</pre>
     *
     ...
     *     main.Point move(int x, int y) { ... }
     * }</pre>
     *
     * <p>Then the static method must be something like this:
     *
     * <pre>class Verbose {
     *     static main.Point print(main.Point target, int x, int y) { ... }
     * }</pre>
     *
     * <p>The <code>CodeConverter</code> would translate bytecode
     * equivalent to:
     *
     * <pre>main.Point p2 = p.move(x + y, 0);</pre>
     *
     * <p>into the bytecode equivalent to:
     *
     * <pre>main.Point p2 = Verbose.print(p, x + y, 0);</pre>
     *
     * @param origMethod   original method
     ...
     *
     * <pre>class Verbose {
     *     static void print(main.Point target, int x, int y) { ... }
     * }</pre>
     *
     * <p>The <code>CodeConverter</code> would translate bytecode
     * equivalent to:
     ...
     * main.Point p2 = p.move(tmp1, tmp2);</pre>
     *
     ...
     * int tmp1 = x + y;
     * int tmp2 = 0;
     * main.Point p2 = p.move(tmp1, tmp2);
