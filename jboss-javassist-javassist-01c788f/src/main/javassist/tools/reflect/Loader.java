 ...
 *         = (javassist.tools.reflect.Loader)main.Main.class.getClassLoader();
 ...
 *
 * <pre>% java javassist.tools.reflect.Loader main.Main arg1, ...</pre>
 *
 * <p>This command runs <code>main.Main.main()</code> with <code>arg1</code>, ...
 * and <code>main.Main.main()</code> runs <code>MyApp.main()</code> with
 * <code>arg1</code>, ...
 ...
 *
 * <p>The difference from the former one is that the class <code>main.Main</code>
 * is loaded by <code>javassist.tools.reflect.Loader</code> whereas the class
 * <code>Main2</code> is not.  Thus, <code>main.Main</code> belongs
