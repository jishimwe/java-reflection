 ...
 *
 * <pre>% java javassist.tools.web.Viewer <i>host port</i> main.Main arg1, ...</pre>
 *
 * <p>This command calls <code>main.Main.main()</code> with <code>arg1,...</code>
 * All classes including <code>main.Main</code> are fetched from
